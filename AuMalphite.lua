...
local patchNotesVersion, scriptVersionUpdater = "1.1.1", "1.1.1"
...
SDK.AutoUpdate("https://github.com/roburAURUM/robur-AuEdition/raw/main/AuMalphite.lua", scriptVersionUpdater)
