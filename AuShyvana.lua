...
local patchNotesPreVersion = "0.9.0"
local patchNotesVersion, scriptVersionUpdater = "1.0.0", "1.0.0"
...
SDK.AutoUpdate("https://github.com/roburAURUM/robur-AuEdition/raw/main/AuShyvana.lua", scriptVersionUpdater)
