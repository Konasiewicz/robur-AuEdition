...
local patchNotesVersion, scriptVersionUpdater = "1.0.3", "1.0.3"
...
SDK.AutoUpdate("https://raw.githubusercontent.com/roburAURUM/robur-AuEdition/main/AuLissandra.lua", scriptVersionUpdater)
