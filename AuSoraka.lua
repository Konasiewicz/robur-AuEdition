...
SDK.AutoUpdate("https://github.com/roburAURUM/robur-AuEdition/raw/main/AuSoraka.lua", scriptVersionUpdater)
...
function Soraka.InitMenu()
    ...
    local function SorakaMenu()
        ...
        if Menu.Checkbox("Soraka.Updates115", "Don't show updates") == false then
            Menu.Separator()
